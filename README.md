...
- packs a compatibility tested version - current:
  [v2.2.0](https://github.com/Dash-Industry-Forum/dash.js/releases/tag/v2.2.0) - of
...
[dash.js sample player](http://dashif.org/reference/players/javascript/v2.2.0/samples/dash-if-reference-player/).
...
<!-- <script src="//cdn.dashjs.org/v2.2.0/dash.all.min.js"></script> -->
